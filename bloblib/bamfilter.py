...
def main():
    ...
    if include_f and exclude_f:
        ...
        BtIO.parseBamForFilter(bam_f, out_f, sequence_list, None, no_gzip, do_sort, keep_sorted, sort_threads)
    elif exclude_f:
        sequence_list = BtIO.parseList(include_f)
        BtIO.parseBamForFilter(bam_f, out_f, None, sequence_list, no_gzip, do_sort, keep_sorted, sort_threads)
    else:
        BtIO.parseBamForFilter(bam_f, out_f, None, None, no_gzip, do_sort, keep_sorted, sort_threads)
